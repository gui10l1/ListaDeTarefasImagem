...
public class TarefaDAO {
    ...
    public static ArrayList<Tarefa> buscarTarefaDoUsusario(Usuario u){
        ...
        try(Connection conn = Conexao.abrirConexao()){
            ...
            while(rs.next()){
                ...
                String caminhoImagem = rs.getString("dir_imagem");
                ...
                t.setCaminhoImagem(caminhoImagem);
    ...
    public static boolean inserirTarefa(Tarefa t){
        ...
        try(Connection conn = Conexao.abrirConexao()){
            PreparedStatement stmnt = conn.prepareStatement("INSERT INTO db_listadetarefas.tb_tarefas (des_assunto, id_usuario, dir_imagem) values (?, ?, ?)");
            
            stmnt.setString(1, t.getAssunto());
            stmnt.setInt(2, t.getIdUsuario());
            stmnt.setString(3, t.getCaminhoImagem()); 
